...
const ExperiencesData = [
    ...
    },
  {
    ...
    extraText: "My professional life has benefited greatly from this internship because it taught me a lot about working in a team environment. I had a mentor from Workday who worked with me one-on-one once a week to keep me on track with my projects and professional development. I have grown as an individual understanding how to work in a professional setting and also collaborate with other students. Over the course of 10 weeks, I learn backend and frontend development using React js, PostgreSQL, Html, Css, Node.js, and Express. Aside from learning, I made some amazing connections and friendships online.",
},
  {
    imgsrc: mongoDb,
